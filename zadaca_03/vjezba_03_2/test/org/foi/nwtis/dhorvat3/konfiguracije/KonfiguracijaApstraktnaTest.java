...
public class KonfiguracijaApstraktnaTest {
    ...
    @Before
    public void setUp() {
        properties.setProperty("1", "NWTiS");
        properties.setProperty("2", "dfsdf");
    }
    ...
    public void testDodajKonfiguraciju() {
        ...
        Properties postavke = properties;
        KonfiguracijaApstraktna instance = new KonfiguracijaApstraktnaImpl();
        instance.dodajKonfiguraciju(postavke);
        assertEquals(properties, instance.dajSvePostavke());
    }
    ...
    public void testDajPostavku() {
        ...
        String postavka = "1";
        String vrijednost = "NWTiS";
        KonfiguracijaApstraktna instance = new KonfiguracijaApstraktnaImpl();
        instance.spremiPostavku(postavka, vrijednost);
        String expResult = vrijednost;
